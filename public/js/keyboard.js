...
(function() {
  ...
  function VKI_keyClick() {
    ...
    console.log("Now I am Herer "+ character);
    var e = jQuery.Event( 'keydown', { keyCode: 65 } );

              $('#test_trigger').trigger(e);
    return false;
  }
      ...
      if (place || force === true) {
        ...
        while (scr = scr.parentNode) {
          ...
          if (scr.scrollHeight > scr.offsetHeight || scr.scrollWidth > scr.offsetWidth) {
            ...
            self.VKI_keyboard.style.display = (top < 0 || left < 0 || bottom < 0 || right < 0) ? "" : "";
            if (self.VKI_isIE6) self.VKI_iframe.style.display = (top < 0 || left < 0 || bottom < 0 || right < 0) ? "" : "";
          }
        }
